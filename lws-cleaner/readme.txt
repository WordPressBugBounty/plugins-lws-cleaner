...
= 2.4.3 =
* Trashed post now verify correctly that it is indeed a post/page before deleting 
...
* Fixed a translation issue in French where orphaned terms relationships would say "unused terms" instead
* Fixed issue where parent theme would get deleted when removing unused themes

= 2.4.1.1 =
* Unexpected character sent on activation fixed. It could cause unexpected errors with the wp-cli

= 2.4.1 = 
* Minor changes
* Can now remove specific theme/plugin instead of all of them
