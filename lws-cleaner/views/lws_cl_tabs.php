...
$plugins_showcased = array('lws-tools', 'lws-hide-login', 'lws-optimize');
...
<div class="lws_cl_main_bloc">
    ...
    <div class="lws_cl_adbloc">
        <div class="lws_cl_adbloc_left">
            ...
            <img class="lws_cl_ad_img" src="<?php echo esc_url(plugins_url('images/logo_lws.png', __DIR__)) ?>" alt="LWS Logo" width="238px" height="60px">
        ...
        <div class="lws_cl_adbloc_right">
            ...
            <br>
            <img style="vertical-align:sub; margin-right:5px" src="<?php echo esc_url(plugins_url('images/wordpress_blanc.svg', __DIR__)) ?>" alt="LWS Cache Logo" width="20px" height="20px">
            <!-- Need to adapt the URL -->
            <span class="lws_cl_ad_t2"> <?php esc_html_e('15% off your WordPress-optimized hosting with the code: ', 'lws-cleaner'); ?></span>
            <br>
            <div style="margin-top:10px">
                <label onclick="lws_cl_copy_clipboard(this)" class="lws_cl_ad_label lws_cl_tooltip" readonly text="WPEXT15">
                    <span><?php echo esc_html('WPEXT15'); ?></span>
                    <img style="vertical-align: middle; padding-left: 47px;" src="<?php echo esc_url(plugins_url('images/copier.svg', __DIR__)) ?>" alt="Logo Copy Element" width="15px" height="18px">
                    <!-- Need to adapt the URL -->
                </label>
                <a target="_blank" href="<?php echo esc_url('https://www.lws.fr/hebergement_wordpress.php'); ?>"><button type="button" class="lws_cl_ad_button"><?php esc_html_e("Let's go!", 'lws-cleaner'); ?></button></a>
            </div>
        </div>
    </div>
    <!--  END -->
    ...
    <div class="lws_cl_subtitlebloc">
        <img style="margin-top:20px" src="<?php echo esc_url(plugins_url('images/plugin_lws-cleaner.svg', __DIR__)) ?>" alt="LWS Cache Logo" width="100px" height="100px">
        <!-- Change image -->
    ...
    <div class="lws_cl_main_content">
        ...
        <div class="lws_cl_list_block_content">
            ...
            <div class="tab_lws_cl" id='tab_lws_cl_block'>
                <div id="tab_lws_cl" role="tablist" aria-label="Onglets_lws_cl">
                    <?php foreach ($tabs_list as $tab) : ?>
                        <button id="<?php echo esc_attr('nav-' . $tab[0]); ?>" class="tab_nav_lws_cl <?php echo $tab[0] == 'posts' ? esc_attr('active') : ''; ?>" data-toggle="tab" role="tab" aria-controls="<?php echo esc_attr($tab[0]); ?>" aria-selected="<?php echo $tab[0] == 'posts' ? esc_attr('true') : esc_attr('false'); ?>" tabindex="<?php echo $tab[0] == 'posts' ? esc_attr('0') : '-1'; ?>">
            ...
            <?php foreach ($first_tabs as $tab) : ?>
                ...
                <div class="tab-pane main-tab-pane" id="<?php echo esc_attr($tab[0]) ?>" role="tabpanel" aria-labelledby="nav-<?php echo esc_attr($tab[0]) ?>" <?php echo $tab[0] == 'posts' ? esc_attr('tabindex="0"') : esc_attr('tabindex="-1" hidden') ?>>
        ...
        <div class="lws_cl_list_block_ad">
            <?php if (!get_transient('lwscleaner_remind_me') && !get_option('lwscleaner_do_not_ask_again')) : ?>
                <div class="lws_cl_block_ad_for_review">
                    ...
                    <div class="lws_cl_block_ad_review_stars">
                        <img src="<?php echo esc_url(plugins_url('images/notation.svg', __DIR__)) ?>" height="25px" width="159px">
                    </div>
            ...
            <div class="lws_cl_block_ad">
                <div style="display: flex; justify-content: space-between; margin-bottom:15px">
                    <span style="margin-top:5px">
                        <img style="vertical-align:sub; margin-right:5px" src="<?php echo esc_url(plugins_url('images/plugin_lws_tools.svg', __DIR__)) ?>" alt="LWS Cache Logo" width="25px" height="23px">
                        <!-- Need to change -->
                        <span class="lws_cl_block_ad_text"><?php echo esc_html('LWS Tools'); ?></span>
                        <!-- Need to change -->
                    </span>
                    <button class="lws_cl_button_ad_block" onclick="install_plugin(this)" value="lws-tools" id="lws-tools">
                        <!-- Need to change -->
                        <span>
                            <img style="vertical-align:sub; margin-right:5px" src="<?php echo esc_url(plugins_url('images/securise.svg', __DIR__)) ?>" alt="LWS Cache Logo" width="20px" height="19px">
                            <!-- Need to change -->
                        ...
                        <span class="hidden" name="loading" style="padding-left:5px">
                            <img style="vertical-align:sub; margin-right:5px" src="<?php echo esc_url(plugins_url('images/loading.svg', __DIR__)) ?>" alt="" width="18px" height="18px">
                            <!-- Need to change -->
                        </span>
                        <span class="hidden" name="activate"><?php echo esc_html_e('Activate', 'lws-cleaner'); ?></span>
                        <span class="hidden" name="validated">
                            <img style="vertical-align:sub; margin-right:5px" width="18px" height="18px" src="<?php echo esc_url(plugins_url('images/check_blanc.svg', __DIR__)) ?>">
                            <!-- Need to change -->
            ...
            <div class="lws_cl_block_ad">
                <div style="display: flex; justify-content: space-between; margin-bottom:15px">
                    <span style="margin-top:5px">
                        <img style="vertical-align:sub; margin-right:5px" src="<?php echo esc_url(plugins_url('images/plugin_lws_hide_login.svg', __DIR__)) ?>" alt="LWS Cache Logo" width="25px" height="23px">
                        <span class="lws_cl_block_ad_text"><?php echo esc_html('Hide Login'); ?></span>
                    </span>
                    <button class="lws_cl_button_ad_block" onclick="install_plugin(this)" value="lws-hide-login" id="lws-hide-login">
                        <span>
                            <img style="vertical-align:sub; margin-right:5px" src="<?php echo esc_url(plugins_url('images/securise.svg', __DIR__)) ?>" alt="LWS Cache Logo" width="20px" height="19px">
                            <span class="lws_cl_button_text"><?php esc_html_e('Install', 'lws-cleaner'); ?></span>
                        </span>
            ...
            <div class="lws_cl_block_ad">
                <div style="display: flex; justify-content: space-between; margin-bottom:15px">
                    <span style="margin-top:5px">
                        <img style="vertical-align:sub; margin-right:5px" src="<?php echo esc_url(plugins_url('images/lws_optimize_menu.svg', __DIR__)) ?>" alt="LWS Optimize" width="25px" height="23px">
                        <span class="lws_cl_block_ad_text"><?php echo esc_html('LWS Optimize'); ?></span>
                    </span>
                    <button class="lws_cl_button_ad_block" onclick="install_plugin(this)" value="lws-optimize" id="lws-optimize">
                        <span>
                            <img style="vertical-align:sub; margin-right:5px" src="<?php echo esc_url(plugins_url('images/securise.svg', __DIR__)) ?>" alt="" width="20px" height="19px">
                            <span class="lws_cl_button_text"><?php esc_html_e('Install', 'lws-cleaner'); ?></span>
                        </span>
                        <span class="hidden" name="loading" style="padding-left:5px">
                            <img style="vertical-align:sub; margin-right:5px" src="<?php echo esc_url(plugins_url('images/loading.svg', __DIR__)) ?>" alt="" width="18px" height="18px">
                ...
                <span class="lws_cl_text_ad">
                    <?php esc_html_e('Boost your website using LWS Optimize, with file-based cache, file minification, lazy-loading and more', 'lws-cleaner'); ?>
                </span>
            </div>
        </div>
    </div>
                ...
                if (!response.success) {
                    if (response.data.errorCode == 'folder_exists') {
                        var data = {
                            ...
                            _ajax_nonce: '<?php echo esc_attr(wp_create_nonce('activateplugin_cleaner')); ?>',
                        };
                        jQuery.post(ajaxurl, data, function(response) {
